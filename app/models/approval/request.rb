module Approval
  class Request < ApplicationRecord
    ...
    enum request_type: {
        ...
        'Permanent Lock Terminal' => 'permanent_lock_terminal',
        'Lock Terminal' => 'lock_terminal',
        'Unlock Terminal' => 'unlock_terminal',
        'Permanent Lock Merchant' => 'permanent_lock_merchant',
        'Lock Merchant' => 'lock_merchant',
        'Unlock Merchant' => 'unlock_merchant',
        'Permanent Lock Parent Merchant' => 'permanent_lock_parent_merchant',
